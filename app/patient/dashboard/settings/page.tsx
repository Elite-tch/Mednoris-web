...
import { Bell, Shield, Globe, Wallet, LogOut, ChevronRight, Moon, Smartphone } from "lucide-react";
...
export default function SettingsPage() {
  ...
  const sections = [
    {
      ...
      icon: Bell,
      items: [
        { label: "Appointment Reminders", key: "appointmentReminders" },
        { label: "Access Request Alerts", key: "accessRequests" },
        { label: "New Messages", key: "newMessages" },
        { label: "Prescription & Lab Alerts", key: "prescriptionAlerts" },
      ],
    },
    {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <p className="text-gray-400 text-sm mb-8">Manage your account preferences and security.</p>
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
        ...
        <span className="text-xs font-bold text-green-600 bg-green-50 px-3 py-1 rounded-full shrink-0">Active</span>
      </motion.div>
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
        ...
        <p className="font-bold text-brand-primary text-sm mb-4">Account</p>
