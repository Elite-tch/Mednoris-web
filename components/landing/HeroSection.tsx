  ...
  return (
    <section className="relative w-full h-[90vh] flex items-center justify-center overflow-hidden ">
      <div className="grid grid-cols-2">
        <div className="z-10  max-w-3xl pl-10 pt-10 flex flex-col ">
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            className="text-5xl md:text-5xl  font-bold text-brand-primary leading-tight mb-6"
          >
          ...
          <motion.p
            ...
            className="text-lg md:text-lg mb-10 text-gray-700 max-w-2xl"
          >
          ...
          >
            ...
            <a
                href="#how-it-works"
                className="px-6 py-3 border-2 border-primary text-primary font-bold rounded-full hover:bg-white hover:text-brand-primary transition-all cursor-pointer"
              >
                How It Works
              </a>
          </motion.div>
          ...
          <motion.div
            ...
            className="flex flex- items-center gap-6 mt-8 "
          >
            {[
